...
RAPIDAPI_KEY = '05fe0a33f9msh0d73b5ea6c033d1p10b089jsn2f8cf7ed611f'
...
def extract_properties_from_schema(raw_data, include_days_on_market=False):
    ...
    for item in data_section:
        ...
        if sold_timestamp:
            sold_date = datetime.fromtimestamp(sold_timestamp / 1000)
        else:
            sold_date = None
...
def display_properties(properties, title, is_active=False):
    ...
    # Reorder columns: move 'Days on Market' to 9th, 'Discount vs Zestimate' to last
